...
namespace atn {
  ...
  class ANTLR4CPP_PUBLIC ParseInfo final {
  public:
    explicit ParseInfo(ProfilingATNSimulator *atnSimulator);
    ...
    /// number. </returns>
    std::vector<DecisionInfo> getDecisionInfo();
    ...
    std::vector<size_t> getLLDecisions();
    ...
    /// </summary>
    long long getTotalTimeInPrediction();
    ...
    /// </summary>
    long long getTotalSLLLookaheadOps();
    ...
    /// </summary>
    long long getTotalLLLookaheadOps();

    /// <summary>
    /// Gets the total number of ATN lookahead operations for SLL prediction
    /// across all decisions made during parsing.
    /// </summary>
    long long getTotalSLLATNLookaheadOps();

    /// <summary>
    /// Gets the total number of ATN lookahead operations for LL prediction
    /// across all decisions made during parsing.
    /// </summary>
    long long getTotalLLATNLookaheadOps();
    ...
    /// </summary>
    long long getTotalATNLookaheadOps();
    ...
    /// particular decision.
    /// </summary>
    size_t getDFASize(size_t decision);
